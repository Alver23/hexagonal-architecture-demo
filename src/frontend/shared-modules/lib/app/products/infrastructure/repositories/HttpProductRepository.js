...
exports.HttpProductRepository = HttpProductRepository;
exports.productRepository = new HttpProductRepository(new connector_1.Connector(axios_1.axiosInstance));
